...
class HomePage(tk.Frame):
    ...
    PANEL_W = 760   # make panel a bit bigger
    PANEL_H = 480
    ...
    def __init__(self, master):
        ...
        # Preload panel image synchronously (one-time) to show expanded immediately
    ...
    def create_widgets(self):
        ...
        # right: pre-expanded image panel (fixed size) - will not overlap left content
    ...
    def open_admin(self):
        # Admin login dialog with big controls and themed background using admin_dashboard image
